...
const COMPANIES = [
    ["Acne Corp", "acnecorp.com"], ["Globex", "globex.io"], ["Initech", "initech.com"],
    ...
    ["Stark Industries", "stark.io"], ["Monzka Industries", "monzka.co"],
    ["Cyberdyne", "cyberdyne.ai"], ["Tyrell Corp", "tyrell.com"],
    ["Aperture Labs", "aperture.io"], ["Black Mesa", "blackmesa.org"],
    ["Oscorp", "oscorp.com"], ["LexCorp", "lexcorp.com"], ["Nakatani", "nakatani.co"],
...
const LAST = [
    ...
    "Coleman", "Patel", "Nguyen", "Okator", "Rossi", "Kim", "Silva", "Park", "Diaz",
...
const NOTE_TEMPLATES = [
    ...
    (c) => `Wants 550 - SCIM provisioning. Confirm timeline with product before committing.`,
    (c) => `Great demo with ${c}. Two stakeholders engaged, decision expected end of quarter.`,
    (c) => `Comparing us against a competitor on price. Emphasize support SLA and onboarding.`,
...
const run = async () => {
    ...
    for (let i = 0; i < 40; i++) {
        ...
        const ageDays =
            status === "Won" || status === "Lost" ? rand(20, 175) : rand(8, 128);

        leadDocs.push({
            owner,
            name,
            email: emailFor(name, domain),
            phone: `+1 555 8${rand(100, 999)}`,
            company,
            status,
    ...
    console.log(`  Login - alex@timetoprogram.com / Test1234`);
